...
exports.callReader = function(storage) {
  ...
  var postInfo = function(post) {
    ...
    // post can define it by itself
    var metadata = post.constructor.metadata || [];
